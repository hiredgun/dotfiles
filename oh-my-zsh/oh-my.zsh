...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(context os_icon ssh root_indicator dir dir_writable nvm vcs)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status history node_version battery)
